...
function Europa() {
  return (
	<div className="flex flex-col h-screen -mt-[752px] pt-44 lg:flex-row lg:pt-56 mx-auto lg:mx-0">
		...
		<div id="content-1" class="space-y-5 text-white text-center lg:space-y-11 lg:text-left">
            ...
            <div class="pt-5 border-t-2 border-white uppercase flex space-x-14 text-gray-300 justify-center lg:justify-start">
                <div class="space-y-2">
					<label for="">
						avg. distance
					</label>
