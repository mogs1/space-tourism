    ...
    <div className='cover home h-screen' >
      <div className="flex flex-col pt-20 text-center z-20 sm:pt-28 md:pt-80 md:flex-row md:text-left">
        ...
        <div className="md:w-1/2  mx-auto max-w-md ">
          ...
          <p className="text-slate-300 text-xs sm:text-base mt-7">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
        </div>
        ...
        transition={{ease: "linear"}}
         className="mx-auto mt-20">
          <div className="flex justify-center items-center w-48 h-48 bg-white text-inherit rounded-full">
